...
var lyr_Calorporzonas_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/Calorporzonas_2_3.png" /> 1 - 2<br />\
    <img src="styles/legend/Calorporzonas_2_4.png" /> 2 - 6<br />'
        });
var format_peligrodeincendio_3 = new ol.format.GeoJSON();
var features_peligrodeincendio_3 = format_peligrodeincendio_3.readFeatures(json_peligrodeincendio_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_peligrodeincendio_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_peligrodeincendio_3.addFeatures(features_peligrodeincendio_3);
var lyr_peligrodeincendio_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_peligrodeincendio_3, 
                style: style_peligrodeincendio_3,
                interactive: true,
                title: '<img src="styles/legend/peligrodeincendio_3.png" /> peligrodeincendio'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_car_1.setVisible(true);lyr_Calorporzonas_2.setVisible(true);lyr_peligrodeincendio_3.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_car_1,lyr_Calorporzonas_2,lyr_peligrodeincendio_3];
