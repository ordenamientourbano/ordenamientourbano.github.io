...
var lyr_Calorporzonas_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/Calorporzonas_2_0.png" /> 0 - 1<br />\
    <img src="styles/legend/Calorporzonas_2_1.png" /> 1 - 2<br />\
    <img src="styles/legend/Calorporzonas_2_2.png" /> 2 - 5<br />\
    <img src="styles/legend/Calorporzonas_2_3.png" /> 5 - 8<br />\
    <img src="styles/legend/Calorporzonas_2_4.png" /> 8 - 11<br />'
        });
var format_otros_3 = new ol.format.GeoJSON();
var features_otros_3 = format_otros_3.readFeatures(json_otros_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_otros_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_otros_3.addFeatures(features_otros_3);
var lyr_otros_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_otros_3, 
                style: style_otros_3,
                interactive: true,
                title: '<img src="styles/legend/otros_3.png" /> otros'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_car_1.setVisible(true);lyr_Calorporzonas_2.setVisible(true);lyr_otros_3.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_car_1,lyr_Calorporzonas_2,lyr_otros_3];
