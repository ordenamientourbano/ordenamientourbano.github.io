...
var lyr_Calorporzonas_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/Calorporzonas_2_4.png" /> 6 - 9<br />'
        });
var format_cableroto_3 = new ol.format.GeoJSON();
var features_cableroto_3 = format_cableroto_3.readFeatures(json_cableroto_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cableroto_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cableroto_3.addFeatures(features_cableroto_3);
var lyr_cableroto_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_cableroto_3, 
                style: style_cableroto_3,
                interactive: true,
                title: '<img src="styles/legend/cableroto_3.png" /> cableroto'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_car_1.setVisible(true);lyr_Calorporzonas_2.setVisible(true);lyr_cableroto_3.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_car_1,lyr_Calorporzonas_2,lyr_cableroto_3];
