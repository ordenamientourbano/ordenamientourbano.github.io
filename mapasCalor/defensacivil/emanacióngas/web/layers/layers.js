...
var lyr_Calorporzonas_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/Calorporzonas_2_3.png" /> 0 - 0<br />\
    <img src="styles/legend/Calorporzonas_2_4.png" /> 0 - 1<br />'
        });
var format_emanaciongas_3 = new ol.format.GeoJSON();
var features_emanaciongas_3 = format_emanaciongas_3.readFeatures(json_emanaciongas_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_emanaciongas_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_emanaciongas_3.addFeatures(features_emanaciongas_3);
var lyr_emanaciongas_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_emanaciongas_3, 
                style: style_emanaciongas_3,
                interactive: true,
                title: '<img src="styles/legend/emanaciongas_3.png" /> emanaciongas'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_car_1.setVisible(true);lyr_Calorporzonas_2.setVisible(true);lyr_emanaciongas_3.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_car_1,lyr_Calorporzonas_2,lyr_emanaciongas_3];
